#!/usr/bin/env python
# ---------------------------------------------------------------------------
#  PINO_tesla3.py — Tesla Model 3 training script (DEPRECATED)
#  Use EVPINO_train.py with 'tesla3' argument instead:
#    python EVPINO_train.py tesla3 [options]
# ---------------------------------------------------------------------------
...
def train(csv, **kwargs):
    """DEPRECATED: Use EVPINO_train.py tesla3 instead."""
    print("WARNING: This script is deprecated. Use EVPINO_train.py instead:")
    print(f"  python EVPINO_train.py tesla3 --csv {csv}")
    
    # Call new unified training function
    train_vehicle('tesla3', csv=csv, **kwargs)

if __name__ == "__main__":
    ap = argparse.ArgumentParser("DEPRECATED: Use EVPINO_train.py tesla3 instead")
    ap.add_argument("--csv", default="tesla3_train.csv", help="CSV file path")
    ...
    ap.add_argument("--log_csv", default="training_log_tesla3.csv", help="Log file")
    args = ap.parse_args()
    
    print("⚠️  DEPRECATED: This script is deprecated!")
    print("   Use the new unified training script instead:")
    print(f"   python EVPINO_train.py tesla3 --csv {args.csv} --epochs {args.epochs} --L {args.L}")
    print()
